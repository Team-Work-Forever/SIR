...
<main>
  <section class="py-4">
    <div class="d-flex justify-content">
      <a href="/"><button type="button" class="btn btn-secondary px-5 me-2">Back</button></a>
  ...
  <section>
    <form enctype="multipart/form-data" action="/src/controllers/admin/user.php" method="post"
