...
<main>
  <section class="py-4">
    <a href="/src/pages/secure/user/profile.php"><button type="button" class="btn btn-secondary px-5">Back</button></a>
  </section>
  <section>
    <?php
  ...
  <section>
    <form action="/src/controllers/admin/user.php" method="post" class="form-control py-3">
