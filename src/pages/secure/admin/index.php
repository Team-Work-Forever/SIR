  ...
  <main class="bg-light">
    <section class="py-4">
      <div class="d-flex justify-content">
        <a href="/src/pages/secure/"><button class="btn btn-secondary px-5 me-2">Back</button></a>
          ...
          <tbody>
            ...
            foreach ($users as $user) {
              ...
              <tr>
                ...
                <td>
                  <div class="d-flex justify-content">
                    <a href="/src/controllers/admin/user.php?<?= 'user=update&id=' . $user['id'] ?>"><button type="button"
                ...
                <div class="modal-dialog modal-dialog-centered">
                  <div class="modal-content">
                    ...
                    <div class="modal-footer">
                      ...
                      <a href="/src/controllers/admin/user.php?<?= 'user=delete&id=' . $user['id'] ?>"><button type="button"
