<!-- 
    <?php
    // require_once __DIR__ . '/src/infra/middlewares/middleware-not-authenticated.php';
        ...
        <div class="container py-4">
            <header class="pb-3 mb-4 border-bottom">
                <a href="/" class="d-flex align-items-center text-dark text-decoration-none"><img
                        src="/public/assets/images/logo-estg.svg" alt="ESTG" class="mw-100"></a>
            </header>
            <div class="p-5 mb-4 bg-body-tertiary rounded">
                <div class="container-fluid py-5 ">
                    <h1 class="display-5 fw-bold">Olá👋</h1>
                    <div class="d-flex justify-content">
                        <a href="/src/pages/public/signin.php"><button class="btn btn-success btn-lg px-5 me-2">Sign
                                In</button></a>
                        <a href="/src/pages/public/signup.php"><button class="btn btn-info btn-lg px-4">Sign
                                Up</button></a>
                    </div>
                </div>
            </div>
